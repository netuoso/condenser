    ...
    return (
        <span className="logo">
            <svg
                ...
                height="40"
                width="220">
                <title id="steemliberator">SteemLiberator logo</title>
                <g id="steemliberator">
                    <path
                        id="path9"
                ...
                <text
                 ...
                 y="25.725807"
                 x="40.645161"
                 style={{fontStyle:"normal",fontWeight:"normal",fontSize:"40px",lineHeight:"125%",fontFamily:"sans-serif",letterSpacing:"2px",wordSpacing:"0px",fill:"#000000",fillOpacity:1,stroke:"none",strokeWidth:"1px",strokeLinecap:"butt",strokeLinejoin:"miter",strokeOpacity:1}}>
                    <tspan
                       style={{fontStyle:"normal",fontVariant:"normal",fontWeight:"normal",fontStretch:"normal",fontSize:"20px",fontFamily:"STIXVariants"}}
                       y="25.725807"
                       x="40.645161"
                       id="tspan3393">
                       &nbsp;&nbsp;SteemLiberator
